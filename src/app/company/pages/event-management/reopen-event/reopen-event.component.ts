...
@Component({
  selector: 'app-reopen-event',
  templateUrl: './reopen-event.component.html',
  styleUrls: ['./reopen-event.component.css'],
})
export class ReopenEventComponent implements OnInit {
  ...
  updateEvent() {
    if (this.editEventForm.valid) {
      ...
      this._generalService.reopenUpdate(this.editEventForm.value).subscribe(
        (res) => {
          if (res['code'] == 200) {
            this.getEventInfoList = res['data']
