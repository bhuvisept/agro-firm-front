...
@Component({
  selector: 'app-add-truck-units',
  templateUrl: './add-truck-units.component.html',
  styleUrls: ['./add-truck-units.component.css'],
  providers: [NgxSpinnerService],
})
export class AddTruckUnitsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formTwo = this.formbuilder.group({
      ...
      enginePoweroutput: ['', [Validators.required]],
...
dataURItoBlob(dataURI) {
  ...
  // if(this.ulpoadedFiles.length > 0){
  //   this.isUploadImagesBtn = true
  // }else{
  //   this.isUploadImagesBtn = false
  // }
}
  ...
  onSubmit() {
    // this.onSelect(event);
      ...
      data['createdById'] =  this.userObj.userInfo._id
        // data['createdById'] = this.userObj.userInfo.companyId 
